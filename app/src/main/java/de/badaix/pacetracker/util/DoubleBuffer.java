...
public class DoubleBuffer {
    ...
    public double getMedian() {
        ...
        final double[] sortedBuffer = new double[numberOfEntries];
        System.arraycopy(buffer, 0, sortedBuffer, 0, numberOfEntries);
        Arrays.sort(sortedBuffer);
        return sortedBuffer[numberOfEntries / 2];
    }

    /**
     * Gets the average and the variance of the buffer.
     *
     * @return an array of two elements - the first is the average, the second
     * is the variance
     */
