...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener, OnLongClickListener {
    ...
    public static final NumberPicker.Formatter THREE_DIGIT_FORMATTER = new NumberPicker.Formatter() {
        final StringBuilder mBuilder = new StringBuilder();
        final java.util.Formatter mFmt = new java.util.Formatter(mBuilder);
        final Object[] mArgs = new Object[1];
    ...
    public static final NumberPicker.Formatter ONE_DIGIT_FORMATTER = new NumberPicker.Formatter() {
        final StringBuilder mBuilder = new StringBuilder();
        final java.util.Formatter mFmt = new java.util.Formatter(mBuilder);
        final Object[] mArgs = new Object[1];
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mText.addTextChangedListener(tw);
    ...
    private void validateCurrentView(CharSequence str, boolean doUpdate) {
